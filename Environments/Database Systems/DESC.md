...
This Dockerfile is designed for **Database Systems** such as \<brief description of the functionality and purpose of the image\>. It allows you to \<explain what users can do with this image, any main features, etc.\>.
